        ...
        {oauth2Config && (
          <FormControl fullWidth>
            ...
            <Stack spacing={2} id="redirect-uris-section">
              {redirectUris.map((uri, index) => (
                ...
                <Stack key={index} direction="row" spacing={1} alignItems="flex-start">
                  ...
                  <Tooltip title={t('common:actions.delete')}>
                    <IconButton onClick={() => handleRemoveUri(index)} color="error" sx={{mt: 1}} disabled={application.isReadOnly}>
                      <Trash size={20} />
                    </IconButton>
                  </Tooltip>
                </Stack>
              ...
              <Box>
                <Button variant="outlined" startIcon={<Plus />} onClick={handleAddUri} size="small" disabled={application.isReadOnly}>
