...
export default function EditAdvancedSettings({
  ...
  return (
    <Stack spacing={3}>
      <OAuth2ConfigSection oauth2Config={oauth2Config} onOAuth2ConfigChange={handleOAuth2ConfigChange} disabled={agent.isReadOnly} />
      <RedirectURIsSection
      ...
      />
      <CertificateSection agent={agent} editedAgent={editedAgent} onFieldChange={onFieldChange} disabled={agent.isReadOnly} />
    </Stack>
  );
}
