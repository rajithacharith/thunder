...
import {DELEGATED_ONLY_GRANTS} from '../../../utils/delegationGrants';
...
export default function OperationModesSection({
  ...
  return (
    <SettingsCard
      title={t('agents:edit.advanced.oauthAccess.title', 'OAuth 2.0 Access')}
      description={t(
        'agents:edit.advanced.oauthAccess.description',
        'The OAuth 2.0 grants and redirect URIs this agent is authorized to use.',
      )}
    >
      <Stack spacing={3}>
        <Box>
