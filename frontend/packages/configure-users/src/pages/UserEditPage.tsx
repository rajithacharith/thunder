...
export default function UserEditPage() {
  ...
  // AttributesSummarySection and EditUserAttributes each fetch (and cache-share) the same schema
  // themselves; the schema data is only read here to derive the credential fields for the
  // Credentials tab.
  ...
  const showCredentialsTab = !user?.isReadOnly && credentialFields.length > 0;
