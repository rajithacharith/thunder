...
import {useState, useEffect, useCallback, useRef, type SyntheticEvent, type ReactNode, type JSX} from 'react';
...
export default function UserEditPage() {
  ...
  // Only the loading/error state is needed at the page level — AttributesSummarySection and
  // EditUserAttributes each fetch (and cache-share) the same schema themselves.
  const {isLoading: isSchemaLoading, error: schemaError} = useGetUserType(schemaId);
