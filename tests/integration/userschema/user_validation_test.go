...
func (ts *UserValidationTestSuite) SetupSuite() {
	...
	ts.employeeType = "employee" + suffix
	ts.studentType = "student" + suffix
	ts.customerType = "customer" + suffix
	ts.teacherType = "teacher" + suffix
