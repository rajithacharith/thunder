...
// TestDeleteUserSchema tests DELETE /user-types/{id} with valid ID
...
// TestDeleteUserSchemaNotFound tests DELETE /user-types/{id} with non-existent ID
...
// TestDeleteUserSchemaWithInvalidID tests DELETE /user-types/{id} with invalid ID formats
...
// TestDeleteUserSchemaIdempotency tests DELETE /user-types/{id} idempotency
...
// TestDeleteUserSchemaResponseHeaders tests response headers for DELETE /user-types/{id}
