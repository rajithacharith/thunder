...
// TestCreateUserSchema tests POST /user-types with valid data
...
// TestCreateUserSchemaWithComplexSchema tests POST /user-types with complex JSON schema
...
// TestCreateUserSchemaWithDuplicateName tests POST /user-types with duplicate name
...
// TestCreateUserSchemaWithInvalidData tests POST /user-types with invalid request data
...
// TestCreateUserSchemaWithoutContentType tests POST /user-types without Content-Type header
