...
// TestListUserSchemas tests GET /user-types
...
// TestListUserSchemasWithPagination tests GET /user-types with pagination parameters
...
// TestListUserSchemasWithInvalidPagination tests GET /user-types with invalid pagination
