...
// TestGetUserSchemaByID tests GET /user-types/{id} with valid ID
...
// TestGetUserSchemaNotFound tests GET /user-types/{id} with non-existent ID
...
// TestGetUserSchemaWithInvalidID tests GET /user-types/{id} with invalid ID formats
...
// TestGetUserSchemaResponseHeaders tests response headers for GET /user-types/{id}
