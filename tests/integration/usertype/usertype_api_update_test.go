...
// TestUpdateUserSchema tests PUT /user-types/{id} with valid data
...
// TestUpdateUserSchemaNotFound tests PUT /user-types/{id} with non-existent ID
...
// TestUpdateUserSchemaWithNameConflict tests PUT /user-types/{id} with conflicting name
...
// TestUpdateUserSchemaWithInvalidData tests PUT /user-types/{id} with invalid request data
...
// TestUpdateUserSchemaWithComplexData tests PUT /user-types/{id} with complex schema
