...
func (_mock *GoogleOIDCAuthnServiceInterfaceMock) GetInternalUser(sub string) (*userprovider.User, *serviceerror.ServiceError) {
...
func (_c *GoogleOIDCAuthnServiceInterfaceMock_GetInternalUser_Call) Return(user *userprovider.User, serviceError *serviceerror.ServiceError) *GoogleOIDCAuthnServiceInterfaceMock_GetInternalUser_Call {
	_c.Call.Return(user, serviceError)
	return _c
}

func (_c *GoogleOIDCAuthnServiceInterfaceMock_GetInternalUser_Call) RunAndReturn(run func(sub string) (*userprovider.User, *serviceerror.ServiceError)) *GoogleOIDCAuthnServiceInterfaceMock_GetInternalUser_Call {
	_c.Call.Return(run)
	return _c
}
