...
func (_mock *GoogleOIDCAuthnServiceInterfaceMock) GetInternalUser(ctx context.Context, sub string) (*entityprovider.Entity, *serviceerror.ServiceError) {
...
func (_c *GoogleOIDCAuthnServiceInterfaceMock_GetInternalUser_Call) RunAndReturn(run func(ctx context.Context, sub string) (*entityprovider.Entity, *serviceerror.ServiceError)) *GoogleOIDCAuthnServiceInterfaceMock_GetInternalUser_Call {
	_c.Call.Return(run)
	return _c
}
