...
func (_c *GraphInterfaceMock_GetInterceptors_Call) Return(interceptorUnitInterfaces []core.InterceptorUnitInterface) *GraphInterfaceMock_GetInterceptors_Call {
