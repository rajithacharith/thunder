...
func (_mock *ExecutorInterfaceMock) GetUserIDFromContext(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider providers.AuthnProviderManagerInterface) string {
...
func (_c *ExecutorInterfaceMock_GetUserIDFromContext_Call) Run(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider providers.AuthnProviderManagerInterface)) *ExecutorInterfaceMock_GetUserIDFromContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *core.NodeContext
		if args[0] != nil {
			arg0 = args[0].(*core.NodeContext)
...
func (_c *ExecutorInterfaceMock_GetUserIDFromContext_Call) RunAndReturn(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider providers.AuthnProviderManagerInterface) string) *ExecutorInterfaceMock_GetUserIDFromContext_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *ExecutorInterfaceMock) ValidatePrerequisites(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider providers.AuthnProviderManagerInterface) bool {
	ret := _mock.Called(ctx, execResp, authnProvider)
...
func (_c *ExecutorInterfaceMock_ValidatePrerequisites_Call) Run(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider providers.AuthnProviderManagerInterface)) *ExecutorInterfaceMock_ValidatePrerequisites_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *core.NodeContext
		if args[0] != nil {
			arg0 = args[0].(*core.NodeContext)
...
func (_c *ExecutorInterfaceMock_ValidatePrerequisites_Call) RunAndReturn(run func(ctx *core.NodeContext, execResp *common.ExecutorResponse, authnProvider providers.AuthnProviderManagerInterface) bool) *ExecutorInterfaceMock_ValidatePrerequisites_Call {
	_c.Call.Return(run)
	return _c
}
