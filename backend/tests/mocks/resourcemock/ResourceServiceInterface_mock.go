...
func (_mock *ResourceServiceInterfaceMock) GetActionList(ctx context.Context, resourceServerID string, resourceID *string, limit int, offset int) (*resource.ActionList, *common.ServiceError) {
	...
	var r1 *common.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *string, int, int) (*resource.ActionList, *common.ServiceError)); ok {
...
func (_c *ResourceServiceInterfaceMock_GetActionList_Call) RunAndReturn(run func(ctx context.Context, resourceServerID string, resourceID *string, limit int, offset int) (*resource.ActionList, *common.ServiceError)) *ResourceServiceInterfaceMock_GetActionList_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetResourceServerByHandle provides a mock function for the type ResourceServiceInterfaceMock
func (_mock *ResourceServiceInterfaceMock) GetResourceServerByHandle(ctx context.Context, handle string) (*providers.ResourceServer, *common.ServiceError) {
...
// ResourceServiceInterfaceMock_GetResourceServerByHandle_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetResourceServerByHandle'
type ResourceServiceInterfaceMock_GetResourceServerByHandle_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - handle string
func (_e *ResourceServiceInterfaceMock_Expecter) GetResourceServerByHandle(ctx interface{}, handle interface{}) *ResourceServiceInterfaceMock_GetResourceServerByHandle_Call {
	return &ResourceServiceInterfaceMock_GetResourceServerByHandle_Call{Call: _e.mock.On("GetResourceServerByHandle", ctx, handle)}
}

func (_c *ResourceServiceInterfaceMock_GetResourceServerByHandle_Call) Run(run func(ctx context.Context, handle string)) *ResourceServiceInterfaceMock_GetResourceServerByHandle_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *ResourceServiceInterfaceMock_GetResourceServerByHandle_Call) Return(resourceServer *providers.ResourceServer, serviceError *common.ServiceError) *ResourceServiceInterfaceMock_GetResourceServerByHandle_Call {
	_c.Call.Return(resourceServer, serviceError)
	return _c
}

func (_c *ResourceServiceInterfaceMock_GetResourceServerByHandle_Call) RunAndReturn(run func(ctx context.Context, handle string) (*providers.ResourceServer, *common.ServiceError)) *ResourceServiceInterfaceMock_GetResourceServerByHandle_Call {
	_c.Call.Return(run)
	return _c
}
