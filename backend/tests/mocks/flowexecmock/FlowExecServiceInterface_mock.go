...
func (_mock *FlowExecServiceInterfaceMock) Execute(appID string, flowID string, actionID string, flowType string, inputData map[string]string) (*flow.FlowStep, *serviceerror.ServiceError) {
	...
	if returnFunc, ok := ret.Get(0).(func(string, string, string, string, map[string]string) (*flow.FlowStep, *serviceerror.ServiceError)); ok {
		return returnFunc(appID, flowID, actionID, flowType, inputData)
	}
	if returnFunc, ok := ret.Get(0).(func(string, string, string, string, map[string]string) *flow.FlowStep); ok {
...
func (_c *FlowExecServiceInterfaceMock_Execute_Call) Return(flowStep *flow.FlowStep, serviceError *serviceerror.ServiceError) *FlowExecServiceInterfaceMock_Execute_Call {
	_c.Call.Return(flowStep, serviceError)
	return _c
}

func (_c *FlowExecServiceInterfaceMock_Execute_Call) RunAndReturn(run func(appID string, flowID string, actionID string, flowType string, inputData map[string]string) (*flow.FlowStep, *serviceerror.ServiceError)) *FlowExecServiceInterfaceMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}
