...
func (_mock *NodeInterfaceMock) Execute(ctx *NodeContext) (*common.NodeResponse, *common0.ServiceError) {
...
func (_c *NodeInterfaceMock_Execute_Call) RunAndReturn(run func(ctx *NodeContext) (*common.NodeResponse, *common0.ServiceError)) *NodeInterfaceMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}
