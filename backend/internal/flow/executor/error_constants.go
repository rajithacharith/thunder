...
var (
	...
	ErrUserNotFound = serviceerror.ServiceError{
	...
	ErrFailedToIdentifyUser = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1002",
		Error: core.I18nMessage{
	...
	ErrAmbiguousUserIdentity = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1003",
		Error: core.I18nMessage{
	...
	ErrUserNotAuthenticated = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1004",
		Error: core.I18nMessage{
	...
	ErrInvalidCredentials = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1005",
		Error: core.I18nMessage{
	...
	ErrUserAuthFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1006",
		Error: core.I18nMessage{
	...
	ErrUserAlreadyExists = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1007",
		Error: core.I18nMessage{
	...
	ErrInvalidOTP = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1008",
		Error: core.I18nMessage{
	...
	ErrMaxOTPAttemptsReached = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1009",
		Error: core.I18nMessage{
	...
	ErrInvalidMagicLinkToken = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1010",
		Error: core.I18nMessage{
	...
	ErrMagicLinkGeneration = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1011",
		Error: core.I18nMessage{
	...
	ErrInvalidOAuthState = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1012",
		Error: core.I18nMessage{
	...
	ErrNonceMismatch = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1013",
		Error: core.I18nMessage{
	...
	ErrInvalidOAuthCode = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1014",
		Error: core.I18nMessage{
	...
	ErrInvalidFederatedUser = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1015",
		Error: core.I18nMessage{
	...
	ErrInvalidPasskey = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1016",
		Error: core.I18nMessage{
	...
	ErrNoRegisteredPasskeys = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1017",
		Error: core.I18nMessage{
	...
	ErrUserIDRequiredForPasskeyReg = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1018",
		Error: core.I18nMessage{
	...
	ErrPasskeyRegistrationFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1019",
		Error: core.I18nMessage{
	...
	ErrPasskeyAuthFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1020",
		Error: core.I18nMessage{
	...
	ErrProvisioningUserAttrsMissing = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1021",
		Error: core.I18nMessage{
	...
	ErrProvisioningFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1022",
		Error: core.I18nMessage{
	...
	ErrProvisioningAssignmentFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1023",
		Error: core.I18nMessage{
	...
	ErrCrossOUProvisioningTargetMissing = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1024",
		Error: core.I18nMessage{
	...
	ErrUserAlreadyExistsInTargetOU = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1025",
		Error: core.I18nMessage{
	...
	ErrCannotProvisionAutomatically = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1026",
		Error: core.I18nMessage{
	...
	ErrSelfRegistrationDisabled = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1027",
		Error: core.I18nMessage{
	...
	ErrInsufficientPermissions = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1028",
		Error: core.I18nMessage{
	...
	ErrAuthorizationFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1029",
		Error: core.I18nMessage{
	...
	ErrInvalidOU = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1030",
		Error: core.I18nMessage{
	...
	ErrOUNotFound = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1031",
		Error: core.I18nMessage{
	...
	ErrOUNameConflict = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1032",
		Error: core.I18nMessage{
	...
	ErrOUHandleConflict = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1033",
		Error: core.I18nMessage{
	...
	ErrOUCreationPrereqFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1034",
		Error: core.I18nMessage{
	...
	ErrOUResolutionFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1035",
		Error: core.I18nMessage{
	...
	ErrOUCreationFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1036",
		Error: core.I18nMessage{
	...
	ErrEmailSendFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1037",
		Error: core.I18nMessage{
	...
	ErrEmailRecipientMissing = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1038",
		Error: core.I18nMessage{
	...
	ErrSMSRecipientMissing = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1040",
		Error: core.I18nMessage{
	...
	ErrSMSInvalidPhone = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1041",
		Error: core.I18nMessage{
	...
	ErrSMSTemplateMissing = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1042",
		Error: core.I18nMessage{
	...
	ErrSMSProviderNotConfigured = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1043",
		Error: core.I18nMessage{
	...
	ErrPrerequisitesFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1044",
		Error: core.I18nMessage{
	...
	ErrUserIDMissingInContext = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1045",
		Error: core.I18nMessage{
	...
	ErrCredentialInputMissing = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1046",
		Error: core.I18nMessage{
	...
	ErrCredentialInputInvalid = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1047",
		Error: core.I18nMessage{
	...
	ErrCredentialValueEmpty = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1048",
		Error: core.I18nMessage{
	...
	ErrCredentialSetFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1049",
		Error: core.I18nMessage{
	...
	ErrAttributeCollectFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1050",
		Error: core.I18nMessage{
	...
	ErrHTTPRequestConfigInvalid = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1051",
		Error: core.I18nMessage{
	...
	ErrAuthNotAvailableForApp = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1052",
		Error: core.I18nMessage{
	...
	ErrSelfRegNotAvailableForApp = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1053",
		Error: core.I18nMessage{
	...
	ErrNoValidUserTypes = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1054",
		Error: core.I18nMessage{
	...
	ErrUserTypeNotAllowed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1055",
		Error: core.I18nMessage{
	...
	ErrInvalidUserType = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1056",
		Error: core.I18nMessage{
	...
	ErrNoUserTypesAvailable = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1057",
		Error: core.I18nMessage{
	...
	ErrUserTypeRetrievalFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1058",
		Error: core.I18nMessage{
	...
	ErrUserTypeNotValidForOU = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1059",
		Error: core.I18nMessage{
	...
	ErrSelfRegDisabledForUserType = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1060",
		Error: core.I18nMessage{
	...
	ErrAttributeNotFoundForUser = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1061",
		Error: core.I18nMessage{
	...
	ErrAttributeNotUnique = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1062",
		Error: core.I18nMessage{
	...
	ErrAttributeRetrievalFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1063",
		Error: core.I18nMessage{
	...
	ErrCredentialProcessingFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1064",
		Error: core.I18nMessage{
	...
	ErrInvalidAction = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1065",
		Error: core.I18nMessage{
	...
	ErrConsentPrereqFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1066",
		Error: core.I18nMessage{
	...
	ErrConsentDenied = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1067",
		Error: core.I18nMessage{
	...
	ErrConsentDecisionsMissing = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1068",
		Error: core.I18nMessage{
	...
	ErrConsentDecisionsParseFail = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1069",
		Error: core.I18nMessage{
	...
	ErrConsentPromptTimedOut = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1070",
		Error: core.I18nMessage{
	...
	ErrConsentRecordFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1071",
		Error: core.I18nMessage{
	...
	ErrConsentResolutionFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1072",
		Error: core.I18nMessage{
	...
	ErrHTTPRequestFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1073",
		Error: core.I18nMessage{
	...
	ErrInvalidInviteToken = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1074",
		Error: core.I18nMessage{
	...
	ErrInviteTokenGenerationFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1075",
		Error: core.I18nMessage{
	...
	ErrOUNotValidForUserType = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1076",
		Error: core.I18nMessage{
	...
	ErrOpenID4VPNotConfigured = serviceerror.ServiceError{
	...
	ErrOpenID4VPExpired = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1079",
		Error: core.I18nMessage{
	...
	ErrOpenID4VPVerificationFailed = serviceerror.ServiceError{
		Type: serviceerror.ClientErrorType,
		Code: "FET-1080",
		Error: core.I18nMessage{
