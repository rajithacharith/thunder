...
func (s *GenericFileBasedStore) GetByField(fieldValue string, fieldGetter func(interface{}) string) (interface{}, error) {
...
// GetWithTypeAssertion retrieves an entity and performs type assertion with logging.
func (s *GenericFileBasedStore) GetWithTypeAssertion(id string, resourceName string) (interface{}, bool, error) {
	data, err := s.Get(id)
	if err != nil {
		return nil, false, err
	}

	// Caller needs to perform the actual type assertion
	// This is a helper that can be used in package-specific implementations
