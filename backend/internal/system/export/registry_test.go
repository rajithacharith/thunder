...
func (m *mockResourceExporter) GetResourceByID(id string) (interface{}, string, *serviceerror.ServiceError) {
	return m.resourceByID, m.resourceNameByID, m.getByIDErr
}

func (m *mockResourceExporter) ValidateResource(resource interface{}, id string, logger *log.Logger) (string, *ExportError) {
