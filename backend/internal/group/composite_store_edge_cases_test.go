...
func (suite *CompositeGroupStoreEdgeCaseTestSuite) TestGetGroupMemberCount_BothEmpty() {
	...
	suite.mockDBStore.AssertNotCalled(suite.T(), "GetGroupMembers", mock.Anything, mock.Anything, mock.Anything, mock.Anything)
	suite.mockFileStore.AssertNotCalled(suite.T(), "GetGroupMembers", mock.Anything, mock.Anything, mock.Anything, mock.Anything)
}
