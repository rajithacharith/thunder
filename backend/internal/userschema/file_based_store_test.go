...
func (suite *FileBasedStoreTestSuite) TestGetUserSchemaList() {
	...
	schemas := []UserSchema{
		{ID: "schema-1", Name: "basic_schema", OrganizationUnitID: "ou-1", AllowSelfRegistration: true, Schema: json.RawMessage(schemaJSON)},
		{ID: "schema-2", Name: "extended_schema", OrganizationUnitID: "ou-1", AllowSelfRegistration: false, Schema: json.RawMessage(schemaJSON)},
		{ID: "schema-3", Name: "minimal_schema", OrganizationUnitID: "ou-1", AllowSelfRegistration: true, Schema: json.RawMessage(schemaJSON)},
	}
