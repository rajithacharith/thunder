...
func (_mock *userSchemaStoreInterfaceMock) GetUserSchemaListByOUIDs(ctx context.Context, ouIDs []string, limit int, offset int) ([]UserSchemaListItem, error) {
	...
	var r0 []UserSchemaListItem
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string, int, int) ([]UserSchemaListItem, error)); ok {
		return returnFunc(ctx, ouIDs, limit, offset)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string, int, int) []UserSchemaListItem); ok {
...
func (_c *userSchemaStoreInterfaceMock_GetUserSchemaListByOUIDs_Call) Return(userSchemaListItems []UserSchemaListItem, err error) *userSchemaStoreInterfaceMock_GetUserSchemaListByOUIDs_Call {
	_c.Call.Return(userSchemaListItems, err)
	return _c
}

func (_c *userSchemaStoreInterfaceMock_GetUserSchemaListByOUIDs_Call) RunAndReturn(run func(ctx context.Context, ouIDs []string, limit int, offset int) ([]UserSchemaListItem, error)) *userSchemaStoreInterfaceMock_GetUserSchemaListByOUIDs_Call {
	_c.Call.Return(run)
	return _c
}
