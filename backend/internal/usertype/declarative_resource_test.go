...
type UserSchemaExporterTestSuite struct {
	suite.Suite
	mockService *usertypemock.UserSchemaServiceInterfaceMock
...
func (s *UserSchemaExporterTestSuite) SetupTest() {
	s.mockService = usertypemock.NewUserSchemaServiceInterfaceMock(s.T())
	s.exporter = usertype.NewUserSchemaExporterForTest(s.mockService)
...
func (s *UserSchemaExporterTestSuite) TestGetAllResourceIDs_Success() {
	expectedResponse := &usertype.UserSchemaListResponse{
...
func (s *UserSchemaExporterTestSuite) TestGetResourceByID_Success() {
	expectedSchema := &usertype.UserSchema{
		ID:   "schema1",
		Name: "Test Schema",
	}
