...
// GetGroupCountForUser provides a mock function for the type UserServiceInterfaceMock
func (_mock *UserServiceInterfaceMock) GetGroupCountForUser(ctx context.Context, userID string) (int, *serviceerror.ServiceError) {
	ret := _mock.Called(ctx, userID)
...
// UserServiceInterfaceMock_GetGroupCountForUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetGroupCountForUser'
type UserServiceInterfaceMock_GetGroupCountForUser_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userID string
func (_e *UserServiceInterfaceMock_Expecter) GetGroupCountForUser(ctx interface{}, userID interface{}) *UserServiceInterfaceMock_GetGroupCountForUser_Call {
	return &UserServiceInterfaceMock_GetGroupCountForUser_Call{Call: _e.mock.On("GetGroupCountForUser", ctx, userID)}
}

func (_c *UserServiceInterfaceMock_GetGroupCountForUser_Call) Run(run func(ctx context.Context, userID string)) *UserServiceInterfaceMock_GetGroupCountForUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *UserServiceInterfaceMock_GetGroupCountForUser_Call) Return(n int, serviceError *serviceerror.ServiceError) *UserServiceInterfaceMock_GetGroupCountForUser_Call {
	_c.Call.Return(n, serviceError)
	return _c
}

func (_c *UserServiceInterfaceMock_GetGroupCountForUser_Call) RunAndReturn(run func(ctx context.Context, userID string) (int, *serviceerror.ServiceError)) *UserServiceInterfaceMock_GetGroupCountForUser_Call {
	_c.Call.Return(run)
	return _c
}
