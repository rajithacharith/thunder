...
func registerMCPTools(server *mcp.Server, themeMgtService ThemeMgtServiceInterface) {
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: `List all themes with summary information (ID, handle, display name). Use thunderid_get_theme_by_id to retrieve full color and typography configuration for a specific theme.`,
