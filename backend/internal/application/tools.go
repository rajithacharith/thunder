...
- Use thunderid_list_themes to pick a theme and set themeId before creating the application (skip for M2M — no login page).
...
- themeId controls the visual appearance of the ThunderID-hosted login page for this application.`,
			...
			InboundAuthConfig: []inboundmodel.InboundAuthConfigWithSecret{
				{
					...
					OAuthConfig: &inboundmodel.OAuthConfigWithSecret{
						...
						GrantTypes:              []oauth2const.GrantType{oauth2const.GrantTypeAuthorizationCode, oauth2const.GrantTypeRefreshToken},
