...
TABLES=("FLOW_CONTEXT" "AUTHORIZATION_CODE" "AUTHORIZATION_REQUEST" "WEBAUTHN_SESSION" "ATTRIBUTE_CACHE" "PAR_REQUEST" "JTI_RECORD" "OPENID4VP_REQUEST_STATE" "OPENID4VCI_NONCE" "OPENID4VCI_CREDENTIAL_OFFER" "RUNTIME_STORE")
