...
#   5. PAR_REQUEST
#   6. JTI_RECORD
#   7. OPENID4VP_REQUEST_STATE
#   8. OPENID4VCI_NONCE
#   9. OPENID4VCI_CREDENTIAL_OFFER
#   10. RUNTIME_STORE
#
# Usage examples:
...
# Tables to clean
TABLES=("AUTHORIZATION_CODE" "AUTHORIZATION_REQUEST" "WEBAUTHN_SESSION" "ATTRIBUTE_CACHE" "PAR_REQUEST" "JTI_RECORD" "OPENID4VP_REQUEST_STATE" "OPENID4VCI_NONCE" "OPENID4VCI_CREDENTIAL_OFFER" "RUNTIME_STORE")
