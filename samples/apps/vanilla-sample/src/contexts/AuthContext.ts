...
/**
 * AuthContext provides authentication state management for the application. Unlike the previous
 * Vite-based sample, there is no bearer token held here; the assertion lives only in an httpOnly
 * cookie set by the server. This context just mirrors what the server already knows.
 */
