...
- Used with Thunder's declarative configuration mode for GitOps workflows
...
Exported YAML files contain parameterized variables that need to be provided when running Thunder with declarative configuration mode. This section explains how to inject these values using environment variables.
...
# Start Thunder with declarative configuration
./start.sh
```
...
- Learn how to [use exported configurations with Declarative Configuration Mode](./declarative-configuration.md)
