...
| `options.loginHintToken` | `string` | — | Defined in the CIBA specification but **not supported** by <ProductName />. The server returns `invalid_request` when this parameter is provided. |
