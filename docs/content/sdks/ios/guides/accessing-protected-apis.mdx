...
description: Make authenticated API requests using the iOS SDK
---

# Accessing Protected APIs

When your app needs to call a backend API that requires authentication, use `ThunderClient.getAccessToken()` to retrieve a valid access token and attach it as a Bearer token to your requests. The SDK automatically refreshes the token if it has expired.
...
func fetchProtectedResource(state: ThunderState) async throws -> Data {
