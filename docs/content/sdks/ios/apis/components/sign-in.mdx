---
title: SignIn
description: Embedded sign-in form driven by the Flow Execution API
---
...
Use `onComplete` to navigate away from the sign-in screen after a successful sign-in. `ThunderState.user` is updated automatically before this callback fires.
