...
description: Core authentication client for the ThunderID Android SDK
---
...
| :--- | :--- | :---: | :--- |
| `config` | `ThunderIDConfig` | ✅ | SDK configuration. See [Configuration](/docs/next/sdks/android/apis/configuration). |
