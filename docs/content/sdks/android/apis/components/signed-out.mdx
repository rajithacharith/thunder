...
The `SignedOut` composable conditionally renders its content only when the user is **not** authenticated. It is the counterpart to [`SignedIn`](/docs/next/sdks/android/apis/components/signed-in).
