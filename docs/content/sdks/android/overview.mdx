...
To get started quickly, follow the [Android Quickstart Guide](/docs/next/guides/getting-started/connect-your-application/android) for step-by-step setup instructions.
