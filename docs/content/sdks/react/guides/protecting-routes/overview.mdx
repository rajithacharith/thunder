...
<Grid container spacing={3} sx={{mb: 4}}>
  <Grid size={{xs: 12, sm: 6}}>
    <SDKCard
      ...
      title="React Router"
      packageName="@asgardeo/react-router"
      packageManager="npm"
      description="Protect routes in React Router v6 applications with the official Asgardeo integration package."
      href="/docs/sdks/react/guides/protecting-routes/react-router"
    />
  </Grid>
  <Grid size={{xs: 12, sm: 6}}>
    <SDKCard
      ...
      packageName="@asgardeo/tanstack-router"
      packageManager="npm"
      description="Protect routes in TanStack Router applications with the official Asgardeo integration package."
      href="/docs/sdks/react/guides/protecting-routes/tanstack-router"
    />
  </Grid>
</Grid>
...
<Typography variant="body1" color="text.secondary" sx={{mb: 3}}>
  Prefer to build your own route protection? Learn how to create custom route guards using Asgardeo primitives in our{' '}
  [custom implementation guide](/docs/sdks/react/guides/protecting-routes/custom).
</Typography>
