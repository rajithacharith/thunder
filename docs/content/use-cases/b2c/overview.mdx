...
The [B2C integration patterns](../integration-patterns) guide helps you compare these options and choose the right integration style before you move into implementation.
