...
- **[Fine-Grained Authorization](#configure-fine-grained-authorization-in-kong-konnect):** Leverage <ProductName />'s [RBAC](/docs/next/guides/key-concepts/authorization/) capabilities to enforce strict, Kong-driven access control policies on upstream APIs.
...
## Configure Fine-Grained Authorization in Kong Konnect
