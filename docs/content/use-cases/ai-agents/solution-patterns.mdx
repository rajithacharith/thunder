...
This flow is built using the OpenID Connect CIBA grant. See [Backchannel Authentication (CIBA)](/docs/next/guides/guides/protocols/oauth-oidc/backchannel-authentication).
