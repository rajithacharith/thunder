---
title: Overview
description: Frontend contribution guidelines for Thunder's React applications.
sidebar_position: 1
...
Thunder includes a CLI scaffolding tool (`@thunder/create`) that generates production-ready feature packages. See the [Scaffolding Tool](scaffolding-tool.mdx) guide for details.
