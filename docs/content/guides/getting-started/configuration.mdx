...
**`database.runtime.postgres.*`** is only read when `database.runtime.type: postgres`:
...
**`database.runtime.sqlite.*`** is only read when `database.runtime.type: sqlite`:
...
**`database.runtime.redis.*`** is only read when `database.runtime.type: redis`:
...
| `database.runtime.redis.db` | `0` | Redis logical database index (0 to 15) |
...
**`database.user.postgres.*`** is only read when `database.user.type: postgres`:
...
**`database.user.sqlite.*`** is only read when `database.user.type: sqlite`:
