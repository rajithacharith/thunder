...
sidebar_position: 9
persona: app
description: Quick start guide to integrate with a Flutter application
---
...
This is **step 4** of the getting started sequence. By the end you will have a working Flutter app with sign-in and sign-out powered by <ProductName /> on both iOS and Android.
...
In the <ProductName /> console, open the application you registered in step 2 and add the following as an **Allowed Redirect URI**:
