...
You should see the `<SignInButton />` button. Click it to be redirected to the <ProductName />-hosted sign-in page. Login with the test user you created in step 2, then return to your app with the user dropdown displayed.
:::
