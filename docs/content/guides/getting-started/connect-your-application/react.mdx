...
You should see the `<SignInButton />`. Click it, you'll be redirected to the <ProductName />-hosted sign-in page. Login with the test user you created in step 2 and you'll land back in your app with the user profile displayed.
:::
