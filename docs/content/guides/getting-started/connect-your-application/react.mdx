...
The React SDK calls the <ProductName /> API directly from the browser, so you need to allow your app's origin. In the Console, go to **Settings**, and under the **System** section, open the **CORS** tab. Enter `http://localhost:5173` (or the relevant URL for your setup) and click **Add Origin**.
:::
