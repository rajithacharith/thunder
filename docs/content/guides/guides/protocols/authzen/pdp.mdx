...
[Security Configuration](../../../../getting-started/configuration#security-configuration).
...
- [Security Configuration](../../../../getting-started/configuration#security-configuration) describes how to configure the
