...
sidebar_position: 5
description: OpenID Connect Client-Initiated Backchannel Authentication (CIBA) in {{ProductName}} — trigger user authentication on a separate device without a browser redirect.
---
