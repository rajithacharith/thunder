...
- **Resource Server**: container for all resources and actions. Requires a unique `identifier`. When the identifier is set to an absolute URI, the resource server is used in [resource indicator](../resource-indicators) flows (RFC 8707).
