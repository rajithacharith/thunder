...
<ProductName /> ships with two default user types. Learn more about the schemas of these default user types in [User Schema Reference](./user-schema-reference).
...
- [User Schema Reference](./user-schema-reference) - Schema settings, attribute types, and constraint modifiers
