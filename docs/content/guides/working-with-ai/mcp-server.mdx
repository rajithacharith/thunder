...
The MCP server is available at the `/mcp` endpoint on your Thunder instance (default: `https://localhost:8090/mcp`). See [Available Tools](#available-tools) for the complete list of capabilities.
...
- [API Reference](/docs/apis) - Application and Flow Management REST APIs
- [React SDK](/docs/sdks/react/overview) - Asgardeo React SDK documentation
